...
>(function CommentComposerField(
  ...
  return (
    <input
      ...
      className="min-h-15 min-w-0 flex-1 bg-transparent py-2 text-sm leading-none text-foreground outline-none placeholder:text-muted-foreground/70 md:min-h-9"
    />
  )
})
