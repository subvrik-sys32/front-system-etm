...
export function TaskKpisSection({
  ...
  if (isCompact) {
    ...
    return (
      <div className="flex h-8 w-full min-w-0 items-center gap-1.5 overflow-x-auto overscroll-x-contain [-ms-overflow-style:none] scrollbar-none [&::-webkit-scrollbar]:hidden">
        {signal.map(({ key, ...chip }) => (
